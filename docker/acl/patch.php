...
$replacements = [
    ...
    "    // assign cache file when cache is enabled / check if file exists, or write to this file when re-creating\n    \$this->cache_file" => "    if(\$hash !== FilesGalleryAclIntegration::expectedMenuHash()) Json::error('Invalid menu cache hash'); // FILESGALLERY_ACL_MENU_V1\n\n    // assign cache file when cache is enabled / check if file exists, or write to this file when re-creating\n    \$this->cache_file",
...
foreach (['FILESGALLERY_ACL_INIT_V1', 'FILESGALLERY_ACL_FILTER_V1', 'FILESGALLERY_ACL_MENU_V1', 'FILESGALLERY_ACL_PREVIEW_V1'] as $marker) {
